...
if file is not None:
    ...
    if st.button("Visualizza grafici"):
       ...
       st.bar_chart(d_for_plot["max_cycles"], x = d_for_plot["unit_ID"], width = 400, height = 300, use_conteiner_width = True, color = "orange", title = "Numero di cicli per unità", orientation = "vertical")
